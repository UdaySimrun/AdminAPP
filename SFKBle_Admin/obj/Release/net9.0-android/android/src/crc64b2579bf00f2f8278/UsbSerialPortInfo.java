...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SFKBle_Admin.UsbSerialPortInfo, SFKBle_Admin", UsbSerialPortInfo.class, __md_methods);
	}
	...
	public UsbSerialPortInfo ()
	{
		...
		if (getClass () == UsbSerialPortInfo.class) {
			mono.android.TypeManager.Activate ("SFKBle_Admin.UsbSerialPortInfo, SFKBle_Admin", "", this, new java.lang.Object[] {  });
		}
	}
	...
	public UsbSerialPortInfo (android.os.Parcel p0)
	{
		super ();
		if (getClass () == UsbSerialPortInfo.class) {
			mono.android.TypeManager.Activate ("SFKBle_Admin.UsbSerialPortInfo, SFKBle_Admin", "Android.OS.Parcel, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
