...
public class UsbSerialPortInfo_ParcelableCreator
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SFKBle_Admin.UsbSerialPortInfo+ParcelableCreator, SFKBle_Admin", UsbSerialPortInfo_ParcelableCreator.class, __md_methods);
	}

	public UsbSerialPortInfo_ParcelableCreator ()
	{
		super ();
		if (getClass () == UsbSerialPortInfo_ParcelableCreator.class) {
			mono.android.TypeManager.Activate ("SFKBle_Admin.UsbSerialPortInfo+ParcelableCreator, SFKBle_Admin", "", this, new java.lang.Object[] {  });
		}
	}
